...
<head>
    ...
    <div class="reservation-header">
        ...
        <div id="progressPlan" class="container2">
            <h2 class="describe-title">Step progress Bar</h2>
                ...
                <form>
                    ...
                    <div class="person-selection">
                        ...
                        <div class ="childeren-number">
                            ...
                            <input type="number" class="form-control" min="0" max="6" value="0">
                        </div>
                    </div>
                    <button id="reservation-btn" type="submit" class="btn btn-primary" href="reservation-p3">Confirm</button>
